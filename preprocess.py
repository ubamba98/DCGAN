## Code taken from https://github.com/AlexiaJM/Deep-learning-with-cats/blob/master/Setting%20up%20the%20data/preprocess_cat_dataset.py
...
def describePositive():
	for imagePath in glob.glob('CAT*/*.jpg'):
